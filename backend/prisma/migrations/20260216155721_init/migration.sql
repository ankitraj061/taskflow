-- CreateEnum
CREATE TYPE "BoardRole" AS ENUM ('ADMIN', 'WORKER');
...
CREATE TABLE "BoardMember" (
    "id" TEXT NOT NULL,
    "role" "BoardRole" NOT NULL DEFAULT 'WORKER',
...
-- CreateIndex
CREATE UNIQUE INDEX "TaskList_boardId_position_key" ON "TaskList"("boardId", "position");
